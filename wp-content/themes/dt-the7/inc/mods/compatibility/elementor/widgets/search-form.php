<?php
/**
 * The7 elements search widget for Elementor.
 *
 * @package The7
 */
...
class Search_Form extends The7_Elementor_Widget_Base {
	...
	protected function register_controls() {
		$selectors = '{{WRAPPER}}.the7-search-form-icon-position-inside .the7-search-form, {{WRAPPER}}:not(.the7-search-form-icon-position-inside) .the7-search-form__input';
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					$selectors => 'border-radius: {{SIZE}}{{UNIT}}',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors'  => [
					...
					' {{WRAPPER}}.the7-search-form-icon-position-outside .the7-search-form__input' => 'width: min({{SIZE}}{{UNIT}}, 100% - var(--icon-width,30px) - var(--btn-space, 10px));',
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}}.the7-search-form-icon-position-inside .the7-search-form:focus-within, {{WRAPPER}}:not(.the7-search-form-icon-position-inside) .the7-search-form__input:focus' => 'background-color: {{VALUE}}',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}}.the7-search-form-icon-position-inside .the7-search-form:focus-within, {{WRAPPER}}:not(.the7-search-form-icon-position-inside) .the7-search-form__input:focus' => 'border-color: {{VALUE}}',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector'       => '{{WRAPPER}}.the7-search-form-icon-position-inside .the7-search-form:focus-within, {{WRAPPER}}:not(.the7-search-form-icon-position-inside) .the7-search-form__input:focus',
				'fields_options' => [
					'box_shadow_type' => [
						'separator' => 'default',
					],
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors'  => [
					'{{WRAPPER}}.the7-search-form-icon-position-outside .the7-search-form__input:focus' => 'width: min({{SIZE}}{{UNIT}}, 100% - var(--icon-width,30px) - var(--btn-space, 10px));',
		...
		$this->add_basic_responsive_control(
			...
			[
				...
				'selectors'            => [
					'{{WRAPPER}} .the7-search-form__input' => '{{VALUE}}',
				],
			]
		);

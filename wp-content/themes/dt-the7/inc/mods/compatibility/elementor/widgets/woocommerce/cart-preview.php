...
class Cart_Preview extends The7_Elementor_Widget_Base {
	...
	protected function add_widget_title_controls() {
		...
		$this->add_responsive_control( 'widget_title_visibility', [
			...
			'selectors_dictionary' => [
				'always' => '--title-visibility-filled: block; --title-visibility-empty: block;',
				'filled' => '--title-visibility-filled: block;',
				'empty'  => '--title-visibility-empty: block;',
			],
			'separator'            => 'before',
		] );
	...
	protected function add_filled_cart_controls() {
		...
		$this->add_control( 'product_image', [
			...
			'default'      => 'yes',
			'selectors'    => [
				'{{WRAPPER}} .the7-e-mini-cart-product > .product-thumbnail' => 'display: block;',
			],
		] );
		...
		$this->add_control( 'product_quantity_change', [
			...
			'separator'    => 'before',
			'selectors'    => [
				'{{WRAPPER}} .the7-e-mini-cart-product .product-quantity' => 'display: block;',
			],
		] );
		...
		$this->add_control( 'product_quantity_change_position', [
			...
			'selectors_dictionary' => [
				...
				'instead' => 'align-items: center; flex-direction: row; --product-item-quantity-display: none; --product-quantity-change-margin: 0 var(--quantity-change-spacing) 0 0; --product-price-margin: var(--product-price-quantity-spacing) 0 0 0;',
			],
		] );
		...
		$this->add_control( 'footer_position', [
			...
			'selectors_dictionary' => [
				...
				'stick_bottom' => 'flex: 1 1 0; overflow-y: scroll; -webkit-overflow-scrolling: touch;'
			],

...
class Module extends The7_Elementor_Module_Base {
	...
	protected static function render_mini_cart_item( $cart_item_key, $cart_item ) {
		...
		?>
        <div class="the7-e-mini-cart-product woocommerce-cart-form__cart-item <?php echo esc_attr( apply_filters( 'woocommerce_cart_item_class', 'cart_item', $cart_item, $cart_item_key ) ); ?>">
